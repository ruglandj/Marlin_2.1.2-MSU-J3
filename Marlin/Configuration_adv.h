 ...
 */
#define E0_AUTO_FAN_PIN 7 //HE1 on MKS_GEN_L_1.0
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN         5 // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.13 //0.22        // (mm) Compression length applying to all extruders
  #endif
 ...
 */
  ...
  #define PROBING_MARGIN_RIGHT 19 //PROBING_MARGIN
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define Z_CURRENT_HOME  800 // Z_CURRENT
